...
public class ImageSegmentationTransactor extends BaseTransactor<MLImageSegmentation> {
    ...
    protected void onSuccess(
        ...
        if (results == null || results.getMasks() == null) {
            Log.i(ImageSegmentationTransactor.TAG, "detection failed");
            return;
        }
        ...
        int facing = frameMetadata!=null?frameMetadata.getCameraFacing(): Camera.CameraInfo.CAMERA_FACING_FRONT;
