...
import com.mlkit.sample.views.graphic.BaseGraphic;
import com.mlkit.sample.views.graphic.CameraImageGraphic;
import com.mlkit.sample.views.graphic.LocalTextGraphic;
...
public class LocalTextTransactor extends BaseTransactor<MLText> {
    ...
    public LocalTextTransactor(Handler handler, Context context) {
        ...
        MLLocalTextSetting options = new MLLocalTextSetting.Factory().
                ...
                setLanguage(language).create();
        this.detector = MLAnalyzerFactory.getInstance().getLocalTextAnalyzer(options);
        this.mHandler = handler;
    }

    private String getLanguage() {
        String position = SharedPreferencesUtil.getInstance(this.mContext).getStringValue(Constant.POSITION_KEY);
