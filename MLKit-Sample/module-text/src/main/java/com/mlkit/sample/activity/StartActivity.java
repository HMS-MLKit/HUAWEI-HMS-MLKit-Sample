...
public final class StartActivity extends BaseActivity
    ...
    private static final int[] icons = {R.drawable.icon_bcr, R.drawable.icon_gcr, R.drawable.icon_text,
            R.drawable.icon_icr, R.drawable.icon_document, R.drawable.icon_translate};

    private static final int[] titles = {R.string.bcr, R.string.gcr, R.string.text_detection, R.string.icr,
            R.string.document_recognition, R.string.translate};
