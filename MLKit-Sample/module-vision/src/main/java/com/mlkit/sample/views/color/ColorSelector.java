...
public class ColorSelector extends View {
    ...
    public ColorSelector(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray array = context.getTheme().obtainStyledAttributes(attrs, com.mlkit.sample.R.styleable.ColorSelector, defStyleAttr, 0);
        this.mIndicatorColor = array.getColor(com.mlkit.sample.R.styleable.ColorSelector_indicatorColor, Color.WHITE);
        array.recycle();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        width = Math.max(width, ColorSelector.mLongSize);
        height = Math.max(height, ColorSelector.mShortSize);
