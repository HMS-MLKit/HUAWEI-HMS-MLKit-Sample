...
import com.mlkit.sample.face.LiveFaceAnalyseActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void mostPeopleSmile(View view) {
    ...
    public void nearestPeopleSmile(View view) {
        Intent intent = new Intent(MainActivity.this, LiveFaceAnalyseActivity.class);
