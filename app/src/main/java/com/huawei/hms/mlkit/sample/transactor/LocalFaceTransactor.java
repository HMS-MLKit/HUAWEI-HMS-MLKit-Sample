...
import com.huawei.hms.mlkit.sample.views.graphic.LocalFaceGraphic;
...
public class LocalFaceTransactor extends BaseTransactor<List<MLFace>> {
    ...
    protected void onSuccess(
        ...
        LocalFaceGraphic hmsMLLocalFaceGraphic = new LocalFaceGraphic(graphicOverlay, faces, this.mContext, this.isOpenFeatures);
