...
public class IDCardRecognitionActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    RadioGroup.OnCheckedChangeListener radioListener = new RadioGroup.OnCheckedChangeListener() {
        ...
        public void onCheckedChanged(RadioGroup group, int checkedId) {
            switch (checkedId) {
                case R.id.local:
                    Log.i(IDCardRecognitionActivity.TAG, "local");
                    IDCardRecognitionActivity.this.isRemote = false;
                    break;
                case R.id.remote:
                    Log.i(IDCardRecognitionActivity.TAG, "remote");
                    IDCardRecognitionActivity.this.isRemote = true;
                    break;
                default:
                    break;
            }
    ...
    private void startCaptureActivity(MLCnIcrCapture.CallBack callBack, boolean isFront, boolean isLocal) {
        Log.i(IDCardRecognitionActivity.TAG, "startCaptureActivity");
        MLCnIcrCaptureConfig config =
                new MLCnIcrCaptureConfig.Factory().setFront(isFront).setRemote(isLocal).create();
