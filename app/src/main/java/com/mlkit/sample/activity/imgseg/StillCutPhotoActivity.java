...
public class StillCutPhotoActivity extends BaseActivity implements ImageSegmentationResultCallBack {
    private RelativeLayout relativeLayoutLoadPhoto, relativeLayoutCut, relativeLayoutBackgrounds, relativeLayoutSave;
    private GraphicOverlay graphicOverlay;
    private ImageView preview;
    private Uri imageUri, imgBackgroundUri;
            ...
            public void onClick(View view) {
                if (StillCutPhotoActivity.this.processedImage == null) {
                    ...
                    try {
                        ...
                        SmartLog.e("StillCutPhotoActivity", e.getMessage());
                    }
                } else {
